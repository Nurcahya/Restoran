...
<html>
    <head>
        <meta charset="UTF-8">
        <title>POP STEAK - Reservation Point</title>
        ...
        <link rel="stylesheet" href="<?php echo base_url();?>assets/js/jplayer/skin/pixel-industry/pixel-industry.css" />
                ...
                <section id="nav-container">
                    ...
                    <nav id="nav">
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo site_url();?>home/pesanan">List Reservasi</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url();?>home/reservasi_saya">Reservasi Saya</a>
                            </li>
							<li>
                                <a href="<?php echo site_url();?>home/pesan_menu">Pesan Menu</a>
                            </li>
                            <li >
                                <a href="<?php echo site_url();?>home/bantuan">Bantuan</a>
                            </li>
