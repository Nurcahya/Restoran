       ...
       <script  src="<?php echo base_url();?>assets/js/jquery-1.8.3.js"></script> <!-- jQuery library -->   
        ...
        <script  src="<?php echo base_url();?>assets/js/jquery.carouFredSel-6.0.0-packed.js"></script><!-- CarouFredSel carousel plugin -->
        <script  src="<?php echo base_url();?>assets/js/grayScale.js"></script><!-- image grayscale to color effect -->
        <script  src="<?php echo base_url();?>assets/js/jquery.touchSwipe-1.2.5.js"></script><!-- support for touch swipe on mobile devices -->
